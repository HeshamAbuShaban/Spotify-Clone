...
import dev.training.spotify_clone.utils.Event
...
class MusicServiceConnection(
    ...
    private val _curPlayingMusic = MutableLiveData<MediaMetadataCompat?>()
    val curPlayingMusic: LiveData<MediaMetadataCompat?> = _curPlayingMusic
    ...
    private inner class MediaControllerCallback : MediaControllerCompat.Callback() {
        ...
        override fun onMetadataChanged(metadata: MediaMetadataCompat?) {
            _curPlayingMusic.postValue(metadata)
        }
